...
genus_level_18S <- all_years_18S_filtered_meso_Zos %>%
...
taxa_are_rows(genus_level_18S)

# transpose so taxa are rows
otu_table(genus_level_18S) <- t(otu_table(genus_level_18S))

taxa_are_rows(genus_level_18S)

# prepare otu table for function
x <- metagMisc::prepare_inext(
  as.data.frame(otu_table(genus_level_18S)),
...
all_18S_COVERAGE_RAREF_1000 <- phyloseq_coverage_raref(physeq=genus_level_18S, coverage = 0.8, iter = 1000, replace = F, correct_singletons = TRUE, drop_lowcoverage = F)
saveRDS(all_18S_COVERAGE_RAREF_1000, "/Users/parfreylab/Desktop/lab_member_files/bia/Calvert_O-Connor_eelgrass/Data/micro_eukaryotes/all_18S_genus_COVERAGE_RAREF_1000.rds")
all_18S_COVERAGE_RAREF_1000 <- readRDS("/Users/parfreylab/Desktop/lab_member_files/bia/Calvert_O-Connor_eelgrass/Data/micro_eukaryotes/all_18S_genus_COVERAGE_RAREF_1000.rds")
...
write.csv(average_otu_tables_1000_round, "/Users/parfreylab/Desktop/lab_member_files/bia/Calvert_O-Connor_eelgrass/Data/micro_eukaryotes/microeuk_genus_average_otu_tables_1000.csv", quote=F, row.names=F )
...
# average_otu_tables_1000 <- read.csv("Data/micro_eukaryotes/microeuk_genus_average_otu_tables_1000.csv", header=T)
