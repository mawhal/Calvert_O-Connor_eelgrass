...
###  * reviewed by Bia Segovia 20 February 2020
###################################################################
...
##
##
d15 <- read_csv( "Data/abiotic/hakai_abiotic_2015.csv" )
a15 <- d15 %>% 
...
##
##
d16 <- read_csv( "Data/abiotic/hakai_abiotic_2016.csv" )
...
##
##
d17 <- read_csv( "Data/abiotic/corrected_hakai_abiotic_2017.csv" )
a17 <- d17 %>%
  dplyr::mutate( date=dmy(date) ) %>%
...
##
##
d18 <- read_csv( "Data/abiotic/corrected_hakai_abiotic_2018.csv" )
# remove blank rows
...
write_csv( abiotic, "Data/R_Code_for_Data_Prep/master_data/MASTER_abiotic_20200214.csv" )
