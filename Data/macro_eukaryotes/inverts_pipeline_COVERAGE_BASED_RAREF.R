...
write.csv(inverts_1000_metadata, "/Users/bia/PostDoc/projects/Calvert_O-Connor_eelgrass/Data/R_Code_for_Data_Prep/master_data/MASTER_inverts_1000_COVERAGE_RAREF.csv", quote=F, row.names=F)
...
# Read in file
inverts <- read.csv(file="Data/R_Code_for_Data_Prep/master_data/MASTER_grazers_family_to_phyloseq.csv")
...
saveRDS(invert.phyloseq, "Data/macro_eukaryotes/invert_phyloseq_family.rds")
...
# phyloseq object to be used
invert_phyloseq <- readRDS("Data/macro_eukaryotes/invert_phyloseq_family.rds")
View(as.data.frame(otu_table(invert_phyloseq)))
# check if taxa are rows in the phyloseq object
taxa_are_rows(invert_phyloseq)
...
saveRDS(invert_COVERAGE_RAREF_1000, "Data/macro_eukaryotes/invert_family_COVERAGE_RAREF_1000.rds")
...
write.csv(average_otu_tables_1000_round, "Data/macro_eukaryotes/inverts_family_average_otu_tables_1000.csv", quote=F, row.names=F )

inverts_1000 <- read.csv("Data/macro_eukaryotes/inverts_family_average_otu_tables_1000.csv")

inverts_1000_metadata <- inner_join(invert.meta, inverts_1000, by = "ID_year")

write.csv(inverts_1000_metadata, "/Users/bia/PostDoc/projects/Calvert_O-Connor_eelgrass/Data/R_Code_for_Data_Prep/master_data/MASTER_inverts_family_1000_COVERAGE_RAREF.csv", quote=F, row.names=F)
