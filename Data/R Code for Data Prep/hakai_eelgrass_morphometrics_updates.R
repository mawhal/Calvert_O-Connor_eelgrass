...
hakai2015_quad <- read.csv("~/PostDoc/projects/Calvert_O-Connor_eelgrass/Data/data_oconnor/seagrass_emily_files_final_code/Hakai_2015_eelgrass_quadrat_numbered.csv")
...
hakai2015_epi <- read.csv("~/PostDoc/projects/Calvert_O-Connor_eelgrass/Data/data_oconnor/seagrass_emily_files_final_code/Hakai_2015_eelgrass_single_shoots_numbered.csv")
...
hakai2016_eg <- read.csv("~/PostDoc/projects/Calvert_O-Connor_eelgrass/Data/data_oconnor/seagrass_emily_files_final_code/Hakai_2016_eelgrass_quadrat_biomass.csv")
...
hakai2016_algae <- read.csv("~/PostDoc/projects/Calvert_O-Connor_eelgrass/Data/data_oconnor/seagrass_emily_files_final_code/Hakai_2016_eelgrass_quadrat_driftseaweed_na.csv")
...
hakai2016_epi <- read.csv("~/PostDoc/projects/Calvert_O-Connor_eelgrass/Data/data_oconnor/seagrass_emily_files_final_code/Hakai_2016_eelgrass_single.shoots.csv")
...
eg<- read.csv("~/PostDoc/projects/Calvert_O-Connor_eelgrass/Data/data_oconnor/seagrass_emily_files_final_code/Hakai_2017_Eelgrass_Morphometrics_corrected.csv")
...
hakai2017_epi <- read.csv("~/PostDoc/projects/Calvert_O-Connor_eelgrass/Data/data_oconnor/seagrass_emily_files_final_code/Hakai_2017_Epiphyte_Data_corrected.csv")
...
eg18 <- read.csv("~/PostDoc/projects/Calvert_O-Connor_eelgrass/Data/data_oconnor/seagrass_emily_files_final_code/Hakai_2018_Eelgrass_Morphometrics_Macroalgae_Epiphytes_corrected.csv")
...
write.csv(hakai_synthesis_1, "~/PostDoc/projects/Calvert_O-Connor_eelgrass/R Code and Analysis/output data/hakai_quad_combined_20200214.csv")
