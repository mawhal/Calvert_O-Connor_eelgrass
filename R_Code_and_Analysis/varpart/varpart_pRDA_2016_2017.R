...
plot(inverts_varpart_separately_YEARS, digits = 1, Xnames = c('space', 'env', "year"), bg = c('navy', 'tomato', "orange"))
...
plot(prokary_varpart_separately_YEARS_genus, digits = 1, Xnames = c('space', 'env', "year"), bg = c('navy', 'tomato', "orange"))
