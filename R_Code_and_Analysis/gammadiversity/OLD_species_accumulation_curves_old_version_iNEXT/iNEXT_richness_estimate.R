...
#############################################################################
### WITH SAMPLE_SIZE ALL YEARS RAREFIED DATA LOW FREQUENCY *NOT* REMOVED  ###
#############################################################################
...
coverage_based_16S
ggsave("R_Code_and_Analysis/gammadiversity/size_all_years_inext_coverage_based_raref_16S.png", plot = coverage_based_16S, width=250, height=200, units="mm",dpi=300)

sample_size_based_16S <- ggiNEXT(estimate_richness_16S, type=1)
sample_size_based_16S
ggsave("R_Code_and_Analysis/gammadiversity/size_all_years_inext_sample_size_based_raref_16S.png", plot = sample_size_based_16S, width=250, height=200, units="mm",dpi=300)


#############################################################################
### WITH SAMPLE_SIZE ALL YEARS RAREFIED DATA LOW FREQUENCY REMOVED  ###
#############################################################################

### Read table metadata and abundances
microbes_16S_ASV <- read.csv("Data/R_Code_for_Data_Prep/master_data/MASTER_prokary_ASV_level_ALL_RAREFIED_REMOVED_SG_DB.csv", header=T)
names(microbes_16S_ASV)[1:17]
...
coverage_based_16S <- ggiNEXT(estimate_richness_16S, type=3)
coverage_based_16S
ggsave("R_Code_and_Analysis/gammadiversity/size_REMOVED_SG_DB_all_years_inext_coverage_based_raref_16S.png", plot = coverage_based_16S, width=250, height=200, units="mm",dpi=300)

sample_size_based_16S <- ggiNEXT(estimate_richness_16S, type=1)
sample_size_based_16S
ggsave("R_Code_and_Analysis/gammadiversity/size_REMOVED_SG_DB_all_years_inext_sample_size_based_raref_16S.png", plot = sample_size_based_16S, width=250, height=200, units="mm",dpi=300)

#############################################################
### WITH SAMPLE_SIZE ALL YEARS *BUT 2016* RAREFIED DATA  ###
#############################################################

### Read table metadata and abundances
microbes_16S_ASV <- read.csv("Data/R_Code_for_Data_Prep/master_data/MASTER_prokary_ASV_level_2016_NOT_RAREFIED.csv", header=T)
names(microbes_16S_ASV)[1:17]

data_all_16S <- microbes_16S_ASV %>%
  select(., -(c(1:15))) %>% # remove metadata
  summarise_all(., funs(sum)) %>% # sum abundances across all replicates
  tidyr::gather(., "species", "N") %>% # transform into 2 columns 1:species 2:N(summed abundances)
  arrange(., desc(N)) # descending order
...
coverage_based_16S <- ggiNEXT(estimate_richness_16S, type=3)
coverage_based_16S
ggsave("R_Code_and_Analysis/gammadiversity/size_all_years_but_2016_inext_coverage_based_raref_16S.png", plot = coverage_based_16S, width=250, height=200, units="mm",dpi=300)

sample_size_based_16S <- ggiNEXT(estimate_richness_16S, type=1)
sample_size_based_16S
ggsave("R_Code_and_Analysis/gammadiversity/size_all_years_but_2016_inext_sample_size_based_raref_16S.png", plot = sample_size_based_16S, width=250, height=200, units="mm",dpi=300)

################################################
### WITH NON RAREFIED *BUT NORMALIZED* DATA  ###
################################################

microbes_16S_ASV <- read.csv("Data/R_Code_for_Data_Prep/master_data/MASTER_prokary_ASV_level_NONE_RAREFIED_SING_DOUB.csv", header=T)
names(microbes_16S_ASV)[1:17]
...
coverage_based_16S <- ggiNEXT(estimate_richness_16S, type=3)
coverage_based_16S
ggsave("R_Code_and_Analysis/gammadiversity/normalized_all_years_inext_coverage_based_raref_16S.png", plot = coverage_based_16S, width=250, height=200, units="mm",dpi=300)

sample_size_based_16S <- ggiNEXT(estimate_richness_16S, type=1)
sample_size_based_16S
ggsave("R_Code_and_Analysis/gammadiversity/normalized_all_years_inext_sample_size_based_raref_16S.png", plot = sample_size_based_16S, width=250, height=200, units="mm",dpi=300)
...
#################################################################
############# FIVE ITERATIONS KEEPING LOW FREQUENCY #############
#################################################################

### Read table metadata and abundances
microbes_16S_ASV <- read.csv("Data/R_Code_for_Data_Prep/master_data/MASTER_prokary_ASV_level_5_COVERAGE_RAREF.csv", header=T)
names(microbes_16S_ASV)[1:17]

data_all_16S <- microbes_16S_ASV %>%
  select(., -(c(1:16))) %>% # remove metadata
  summarise_all(., funs(sum)) %>% # sum abundances across all replicates
  tidyr::gather(., "species", "N") %>% # transform into 2 columns 1:species 2:N(summed abundances)
  arrange(., desc(N)) # descending order
...
#N     1617    2035.1   53.597  1942.543  2153.974

estimate_richness_16S <- iNEXT(input_all, q= c(0), datatype="abundance", size=NULL, endpoint=NULL, knots=40, se=TRUE, conf=0.95, nboot=50) # q=0 estimates richness

coverage_based_16S <- ggiNEXT(estimate_richness_16S, type=3)
coverage_based_16S
ggsave("R_Code_and_Analysis/gammadiversity/coverage_based_raref_tests/cov_based_raref_5_CB_16S.png", plot = coverage_based_16S, width=250, height=200, units="mm",dpi=300)

sample_size_based_16S <- ggiNEXT(estimate_richness_16S, type=1)
sample_size_based_16S
ggsave("R_Code_and_Analysis/gammadiversity/coverage_based_raref_tests/cov_based_raref_5_SSB_16S.png", plot = sample_size_based_16S, width=250, height=200, units="mm",dpi=300)

############################################################################
############# TWO HUNDRED ITERATIONS KEEPING LOW FREQUENCY #################
############################################################################
...
############################################################################
############# TWO HUNDRED ITERATIONS *REMOVING* LOW FREQUENCY #################
############################################################################

### Read table metadata and abundances
microbes_16S_ASV <- read.csv("Data/R_Code_for_Data_Prep/master_data/MASTER_prokary_ASV_level_200_remove_LFC_COVERAGE_RAREF.csv", header=T)
names(microbes_16S_ASV)[1:17]
...
coverage_based_16S <- ggiNEXT(estimate_richness_16S, type=3)
coverage_based_16S
ggsave("R_Code_and_Analysis/gammadiversity/coverage_based_raref_tests/cov_based_raref_200_REMOVE_LOW_FREQUENCY_CB_16S.png", plot = coverage_based_16S, width=250, height=200, units="mm",dpi=300)

sample_size_based_16S <- ggiNEXT(estimate_richness_16S, type=1)
sample_size_based_16S
ggsave("R_Code_and_Analysis/gammadiversity/coverage_based_raref_tests/cov_based_raref_200__REMOVE_LOW_FREQUENCY_SSB_16S.png", plot = sample_size_based_16S, width=250, height=200, units="mm",dpi=300)
...
#############################################################
### WITH SAMPLE_SIZE RAREFIED data ###
############################################################
...
#Observed Estimator Est_s.e. 95% Lower 95% Upper
#N  257   356.981   26.606   316.878   423.943
...
coverage_based_18S
ggsave("R_Code_and_Analysis/gammadiversity/size_all_years_inext_coverage_based_raref_18S.png", plot = coverage_based_18S, width=250, height=200, units="mm",dpi=300)

sample_size_based_18S <- ggiNEXT(estimate_richness_18S, type=1)
sample_size_based_18S
ggsave( "R_Code_and_Analysis/gammadiversity/size_all_years_inext_sample_size_based_raref_18S.png", plot = sample_size_based_18S, width=250, height=200, units="mm",dpi=300)
...
### Read table metadata and abundances
microbes_18S_ASV <- read.csv("Data/R_Code_for_Data_Prep/master_data/MASTER_microeuk_ASV_level_5_COVERAGE_RAREF.csv", header=T)

names(microbes_18S_ASV)[1:12]

data_all_18S <- microbes_18S_ASV %>%
  select(., -(c(1:10))) %>% # remove metadata
  summarise_all(., funs(sum)) %>% # sum abundances across all replicates
  tidyr::gather(., "species", "N") %>% # transform into 2 columns 1:species 2:N(summed abundances)
  arrange(., desc(N)) # descending order
...
coverage_based_18S <- ggiNEXT(estimate_richness_18S, type=3)
coverage_based_18S
ggsave("R_Code_and_Analysis/gammadiversity/coverage_based_raref_tests/cov_based_raref_5_CB_18S.png", plot = coverage_based_18S, width=250, height=200, units="mm",dpi=300)

sample_size_based_18S <- ggiNEXT(estimate_richness_18S, type=1)
sample_size_based_18S
ggsave("R_Code_and_Analysis/gammadiversity/coverage_based_raref_tests/cov_based_raref_5_SSB_18S.png", plot = sample_size_based_18S, width=250, height=200, units="mm",dpi=300)
